...
//				request.setAttribute("status", "success");
//				request.setAttribute("redirectUrl", "admin-event-dashboard.jsp");
//
//				RequestDispatcher rd = request.getRequestDispatcher("message.jsp");
//				rd.forward(request, response);
//			} else {
...
//				RequestDispatcher rd = request.getRequestDispatcher("event-dashboard.jsp");
//				rd.forward(request, response);
//			} else {
...
//				request.setAttribute("status", "error");
//				request.setAttribute("redirectUrl", "event-dashboard.jsp");
//				RequestDispatcher rd = request.getRequestDispatcher("event-dashboard.jsp");
//				rd.forward(request, response);
//			}
//		} catch (Exception e) {
...
//			request.setAttribute("status", "Failed");
//			request.setAttribute("redirectUrl", "searchByDate");
//			RequestDispatcher rd = request.getRequestDispatcher("event-dashboard.jsp");
//			rd.forward(request, response);
//		}
//	}
